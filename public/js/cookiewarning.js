...
function displayNotification(c_action) {
    ...
    // center vert
    message = message + "<div style='text-align:center;margin:0px;padding:10px;padding-left:20rem;width:auto;background:#EE6363;color:black;font-size:90%;'><div style='position:absolute;'><img src='/public/images/giphy.gif'></div>";

    // this is the message displayed to the user.
    message = message + "This site uses <b>heavy sarcasm</b>, imaginary friends and things that never happened or even might be physically possible. <br />If you are too much of a sissy to handle that, I prefer would prefer if you just go somewhere else <br />and click the \"I don't agree\" button. <br /> Oh, this site also uses some Cloudflare and Github cookies...so here is that standard disclaimer stuff: <br />In order for this site to work correctly, and for us to improve the site we need to store a small file (called a cookie) on your computer. <br /> Most every site in the world does this, however it seems that now, by law, we have to get your permission first. <br /> If you click agree below we will store all needed cookies and you'll notice no difference, if you click on I don't agree we will send you on your merry way..far, far, VERY away from here.<br />";
